...
import { User, LogIn, LogOut, HelpCircle, Globe, WifiOff, RefreshCw } from 'lucide-react';
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline-block text-[11px] font-semibold uppercase bg-cyan-100 text-[#0E7490] px-2 py-0.5 rounded">
              SIH26034
            </span>
          </div>
